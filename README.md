# PaperDaily Design — 论文日报设计系统

> 用清晰、克制、可信的界面，把复杂的前沿知识变成每个人都能更快找到、读懂、用上的信息体验。

PaperDaily 是一套面向全球研究者的设计系统，致力于让前沿研究像一款精心策划的知识杂志一样自然、克制、好读。我们相信，界面工程不只是美观，而是让每个人都能舒服地接近世界的研究前沿。

## 核心理念

### 精准推荐
不必在海量论文中反复搜索，每天直接看到与自己研究方向、兴趣领域和阅读习惯相关的高价值内容。

### 实干 AI
AI 不停留在炫技，而是提炼论文重点、解释方法贡献、生成速读摘要，帮你快速判断一篇论文值不值得读。
